...
class ASPP_places(nn.Module):
    def __init__(self):
        ...
        self.conv_3x3_dil12 = nn.Sequential(
            nn.Conv2d(96,128, kernel_size=1),
            nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=12, dilation=12),
            nn.BatchNorm2d(128)
        )
        self.conv_3x3_dil18 = nn.Sequential(
            nn.Conv2d(96,128, kernel_size=1),
            nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=18, dilation=18),
            nn.BatchNorm2d(128)
        )
...
#         self.bn_conv_1x1_2 = nn.BatchNorm2d(128)
        ...
        self.conv_1x1_3 = nn.Conv2d(4*128, 256, kernel_size=1) # (640 = 5*128)
